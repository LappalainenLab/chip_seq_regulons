...
data = pd.read_table('data/regulons/TF_target_mapping_filtered_merged_MCF7_with_motifs_with_ppi_with_dnase_with_atac_with_dist_score.tsv', sep="\t")
...
df.to_csv("data/enrich_analysis/mcf7_filtering_benchmark.tsv", sep="\t", index=False)
